...
impl PrettyPrint for Primitive {
    ...
    fn pretty_print(
        ...
        match self {
            ...
            Primitive::Assert(Assertion::Subtype) => write!(f, "@assert_sub"),
            Primitive::Assert(Assertion::Supertype) => write!(f, "@assert_super"),
            Primitive::Unop(operator) => match operator {
                Operator::Dot => unreachable!(),
                Operator::Plus => write!(f, "@copy"),
                Operator::Minus => write!(f, "@neg"),
                Operator::Pound => write!(f, "@len"),
                _ => unreachable!(),
            },
            Primitive::Binop(operator) => match operator {
                Operator::Dot => unreachable!(),
                ...
                Operator::Intersection => write!(f, "@intersection"),
